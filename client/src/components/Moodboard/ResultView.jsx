...
export const ResultView = ({
  ...
  if (!currentMoodboard?.compositeMoodboard?.url) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center relative overflow-hidden bg-[#faf8f6] dark:bg-[#0a0a0a]">
  ...
  return (
    <div className="min-h-screen bg-[#faf8f6] dark:bg-[#0a0a0a] transition-colors duration-500 flex flex-col pt-32 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative flex flex-col">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="mb-8 sm:mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6 sm:gap-8 pb-8 sm:pb-12 border-b border-gray-100 dark:border-white/5 flex-shrink-0"
        >
          <div className="min-w-0">
             <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
              <div className="w-8 sm:w-12 h-[1px] bg-[#8d775e]"></div>
              <span className="text-[9px] sm:text-[10px] font-bold tracking-[0.4em] sm:tracking-[0.5em] text-[#8d775e] uppercase">Synthesis Report</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 tracking-tight leading-[1.1] md:leading-[0.9]">
            ...
            <p className="text-gray-400 dark:text-gray-500 text-xs sm:text-sm md:text-lg font-medium">
          ...
          <button
            ...
            className="px-6 sm:px-10 py-3 sm:py-5 rounded-xl sm:rounded-2xl font-bold text-gray-500 hover:text-gray-900 dark:hover:text-white bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 transition-all whitespace-nowrap flex-shrink-0 shadow-lg shadow-black/5 text-sm sm:text-base"
          >
            New Project
          </button>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto w-full pb-12">
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6 }}
              className="relative group rounded-[30px] sm:rounded-[48px] overflow-hidden w-full bg-white dark:bg-[#111] border border-gray-100 dark:border-white/5 flex justify-center shadow-2xl shadow-[#8d775e]/10"
            >
            ...
            <motion.div
              ...
              className="bg-white dark:bg-[#111] rounded-[30px] sm:rounded-[48px] border border-gray-100 dark:border-white/5 overflow-hidden shadow-2xl shadow-black/5"
            >
          ...
          <div className="space-y-6">
            <motion.div
              ...
              className="bg-white dark:bg-[#111] rounded-[30px] sm:rounded-[40px] border border-gray-100 dark:border-white/5 p-6 sm:p-8 lg:sticky lg:top-0 shadow-2xl shadow-black/5"
            >
