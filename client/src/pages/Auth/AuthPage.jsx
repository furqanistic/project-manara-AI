...
const AuthPage = () => {
  const [isLogin, setIsLogin] = useState(() => {
    ...
    return type === 'signup' ? false : true // default to login if no param or invalid param
  })
                      ...
                      >
                          ...
                          <div className='grid grid-cols-2 gap-4'>
                            <div className='relative'>
                              ...
                              <input
                                ...
                                className='w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#947d61]/50 focus:border-transparent transition-all duration-300'
                                required={!isLogin}
                              />
                            </div>
                            <div className='relative'>
                        ...
                        <div className='relative'>
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            className='w-full pl-12 pr-12 py-3 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#947d61]/50 focus:border-transparent transition-all duration-300'
                            required
                          />
                          <button
                            type='button'
                        ...
                        <motion.button
                          type='submit'
                          className='group w-full py-3 px-6 text-white font-semibold rounded-2xl relative overflow-hidden'
                          style={{
                            background: `linear-gradient(135deg, ${brandColor}, ${brandColorLight})`,
